...
#Tema: Algoritmos de busqueda local

""" Teoría
Los algoritmos de búsqueda local en lógica proposicional en inteligencia artificial 
son una familia de técnicas de búsqueda que se utilizan para encontrar una solución 
satisfactoria a una fórmula proposicional.

Estos algoritmos buscan una solución satisfactoria recorriendo un espacio de búsqueda 
de posibles asignaciones de valores de verdad a las variables proposicionales de la fórmula. 
En lugar de explorar todo el espacio de búsqueda, los algoritmos de búsqueda local se 
centran en una solución inicial y buscan una solución vecina que mejore la calidad de la 
solución actual. Este proceso se repite hasta que se encuentra una solución satisfactoria 
o se alcanza un límite de tiempo o iteraciones.
"""
