...
"""Teoria:
    En resumen, el movimiento dentro del enfoque de probabilidad en IA implica 
    la toma de decisiones basada en la incertidumbre y el uso de modelos probabilísticos 
    para estimar la posición y la incertidumbre de un objeto móvil. Se utilizan técnicas 
    como el filtro de Kalman y la localización basada en probabilidades para mejorar 
    la precisión del movimiento y la estimación de la posición. El etiquetado de líneas 
    y la triangulación son también técnicas utilizadas en la percepción del movimiento 
