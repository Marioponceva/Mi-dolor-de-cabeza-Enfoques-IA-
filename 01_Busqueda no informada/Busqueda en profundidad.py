...
#Tema: Busqueda en profundidad

""" Teoría
    La búsqueda en profundidad es un algoritmo de búsqueda no informado 
    que se utiliza para explorar todos los nodos de un grafo o árbol. 
    El objetivo de la búsqueda en profundidad es encontrar un nodo objetivo o 
    recorrer todo el grafo/árbol.
"""
import pygame
import random
import time
