...
#Tema: Busqueda por anchura

""" Teoría
La búsqueda por anchura (también conocida como búsqueda en amplitud) es un 
algoritmo de búsqueda en grafo que explora todos los nodos de un nivel antes 
de avanzar al siguiente nivel. Es decir, comienza explorando el nodo inicial 
y todos sus vecinos inmediatos, luego explora los vecinos de esos vecinos, 
y así sucesivamente hasta que se encuentra el objetivo o se ha explorado 
todo el grafo.
"""
import pygame
import random
