...
#Tema: Busqueda en profundidad limitada

""" Teoría
    La búsqueda en profundidad limitada es una variante de la búsqueda en 
    profundidad en la que se limita la profundidad máxima de exploración. 
    Es decir, en lugar de seguir explorando hasta el final en cada rama, se 
    establece un límite en la profundidad máxima que se puede alcanzar en la 
    exploración.
"""
