...
#Tema: Busqueda por anchura costo uniforme

""" Teoría
La búsqueda por anchura en costo uniforme es una variante de la búsqueda 
por anchura que se utiliza para encontrar la ruta más corta en un grafo ponderado 
(es decir, un grafo en el que cada arista tiene un peso asociado). En lugar de 
explorar todos los nodos de un nivel antes de avanzar al siguiente nivel, 
la búsqueda por anchura en costo uniforme selecciona el nodo con el costo más bajo 
(es decir, la ruta más corta) en cada iteración.
"""
import pygame
import random
import time
